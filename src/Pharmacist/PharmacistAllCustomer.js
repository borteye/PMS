...
import "../static/css/Pharmacist/PharmacistAllCustomer.css";
...
const PharmacistAllCustomer = () => {
  ...
  return (
    <div
      className={
        adminMenuToggle
          ? "pharmacistAllCustomers open"
          : "pharmacistAllCustomers"
      }
    >
      <PharmacistSideBar />
...
export default PharmacistAllCustomer;
